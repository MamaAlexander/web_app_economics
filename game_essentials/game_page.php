...
<body>
<div style="margin-top: -30px; margin-right: 15px; float: right;"><a href="../profile/profile.php"><input type="button" name="login" class="btn btn-primary" value="Go to profile"></a></div>
  <div class="container">
    <div class="text-right mt-5 mb-5">
      ...
      <input type="submit" name="submit" class="btn btn-primary" value="Submit" style="margin-top: 20px"/>
        ...
        echo '<a href="index_game.php"><input type="button" name="button2" class="btn btn-primary" value="Go to the game"></a>
        <a href="../logout.php"><input type="button" name="button" class="btn btn-primary" value="Start new game"></a>';
      }
      ?>
